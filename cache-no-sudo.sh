...
# Laravel Cache & Performance Optimization Script (No Sudo Version)
# This script optimizes Laravel application performance and clears various caches

echo "🚀 Starting Laravel Cache & Performance Optimization (No Sudo)..."
...
echo ""
echo "⚠️  Note: This version doesn't change file ownership."
echo "   If you have permission issues, use cache.sh instead."
